...
export const swingPhases: SwingPhase[] = [
  {
    id: "address",
    label: "Address",
    timestamp: "0.0s",
...
export const swingMetrics: SwingMetric[] = [
  {
    id: "setup",
    label: "Setup",
    score: 88,
...
export const swingFindings: SwingFinding[] = [
  {
    id: "finding-1",
    priority: 1,
    ...
    phase: "Downswing",
    severity: "High",
    evidence: "Hip position moved approximately 9% toward the ball before impact.",
    explanation:
  ...
  },
  {
    ...
    phase: "Top",
    severity: "Medium",
    evidence: "Measured tempo ratio was 2.6:1 compared with the 3:1 target.",
    explanation:
...
export const practicePlan = [
  {
    label: "Warm-up",
    duration: "5 minutes",
    instructions: "Make slow-motion turns while maintaining your address posture.",
  },
  {
    label: "Primary drill",
    duration: "10 minutes",
    instructions: "Complete 15 wall-touch rehearsals followed by five half-speed shots.",
  },
  {
    label: "Tempo work",
    duration: "5 minutes",
